--[[ ABD HUB – SOMENTE AMETHYST UI ]]
-- Se não carregar, mostra erro no console
        ...
        if success and result then
            ...
            if func then
                ...
                if Amethyst then
                    ...
                    print("❌ Func retornou nil")
                end
            else
                print("❌ Erro ao compilar:", err)
            end
        else
...
if not loadAmethyst() then
    print("❌ Falha ao carregar Amethyst UI.")
