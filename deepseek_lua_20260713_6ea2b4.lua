...
print("🚀 Carregando Abd Hub (Amethyst)...")
...
-- =============================================
-- CARREGAR AMETHYST UI (COM FALLBACK)
-- =============================================
local Amethyst
local function loadAmethyst()
    local urls = {
        ...
        "https://raw.githubusercontent.com/Kiddion07/Amethyst/main/source.lua",
...
if not loadAmethyst() then
    print("❌ Falha ao carregar Amethyst UI. Usando interface alternativa...")
    -- Fallback: interface própria (já testada e funcionando)
    -- Vou usar a versão compacta que funcionou antes
    error("Falha ao carregar Amethyst")
end
...
SkillSection:CreateLabel("💡 Ative e faça o minigame manualmente")
...
print("⚔️ Pressione 'K' para abrir/fechar")
print("========================================")